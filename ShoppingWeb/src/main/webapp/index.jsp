...
<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Gifts<span class="caret"></span></a>
        ...
        <li><a href="signup.html">SIGN UP</a><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
        <li><a href="login.html">LOG-IN</a><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
      </ul>
      </div>
    </div>
  </div>
